      ...
      >
        ...
        <div className="relative mx-8 mb-6 w-3/4">
          ...
          <div className="absolute top-1/2 left-1/2 h-14 w-14 -translate-x-1/2 -translate-y-1/2 bg-white">
            <Vecno className="absolute top-1/2 left-1/2 h-13 w-13 -translate-x-1/2 -translate-y-1/2 bg-white" />
          </div>
        </div>

        <div className="text-gray-500">Scan or copy the Vecno address</div>
